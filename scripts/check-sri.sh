...
# Supply-chain security check (gv-230):
# This script ensures that all external scripts/styles
 # loaded from CDns have SRI (Subresource Integrity) hashes.
# This prevents malicious tagging of cdn assets.
